...
The detail page automatically loads the record matching the slug and makes it available as the page context. 
All blocks on that page resolve their bindings against this single record.
