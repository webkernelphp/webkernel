...
namespace Webkernel\BackOffice\System\Models\Traits;
...
trait ManagesSettings
{
    ...
    public static function updateSettingValue(string $dotKey, mixed $value, ?string $modifier = null): void
    {
        ...
        if (class_exists('Webkernel\BackOffice\System\Models\WebkernelSettingHistory')) {
            \Webkernel\BackOffice\System\Models\WebkernelSettingHistory::create([
