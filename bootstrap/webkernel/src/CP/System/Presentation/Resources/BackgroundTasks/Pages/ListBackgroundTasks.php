...
namespace Webkernel\CP\System\Presentation\Resources\BackgroundTasks\Pages;
        ...
        return $table
            ...
            ->actions([
                Action::make('watch')
                    ...
                    ->modalContent(fn (WebkernelBackgroundTask $record) => view('webkernel-system::actions.watch-task', ['task' => $record]))
                    ->disableForm(),
