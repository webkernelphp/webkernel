{{-- webkernel::panels.layout._variables — :root design tokens (private partial) --}}
<style>
:root {
    /* ── Spacing ── */
    ...
    /* ── Content-offset helpers ──
       Computed from the tokens above.
       Override a token and every derived value updates automatically. ── */
    ...
    /* Active offset — overridden contextually via :has() selectors in _desktop. */
