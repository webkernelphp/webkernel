        ...
        @if($isLoading)
            <div class="flex justify-center items-center py-12">
                <div class="text-center">
                    ...
                    <p class="text-slate-600 dark:text-slate-400">Loading marketplace...</p>
                </div>
            </div>
        @elseif(empty($this->filteredModules()))
            <div class="text-center py-12 bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800">
                <svg class="w-12 h-12 text-slate-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
                </svg>
                <p class="text-slate-600 dark:text-slate-400">No modules found</p>
            </div>
        @else
