...
defined('WEBKERNEL_HELPERS_ROOT')          || define('WEBKERNEL_HELPERS_ROOT',          WEBKERNEL_PATH . '/config/helpers');
...
/* --- Platform roots ------*------*------ */
defined('WEBKERNEL_APTITUDES_ROOT')        || define('WEBKERNEL_APTITUDES_ROOT',        WEBKERNEL_PATH . '/platform/aptitudes');
