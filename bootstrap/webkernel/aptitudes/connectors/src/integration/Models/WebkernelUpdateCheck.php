 ...
 *   1. Audit trail — what was checked, when, by whom, result
...
class WebkernelUpdateCheck extends Model
{
    ...
    /**
     * Most recent successful check for a given target.
     */
    ...
    /**
     * True when the instance is currently in a rate-limit window for this target.
     */
    public static function isRateLimited(string $targetType, string $targetSlug): bool
    {
        ...
        if (
            $last->rate_limit_remaining !== null
