...
class WebkernelRelease extends Model
{
    ...
    /**
     * Latest stable release for a given target, ordered by published_at then tag_name.
     * This is the single source of truth for "what is the newest version?" — never stored
     * as a boolean in the DB. Callers compare against their current installed version.
     */
    ...
    /**
     * Build a WebkernelRelease (unsaved) from a raw GitHub tag payload.
     */
    ...
    /**
     * Enrich an existing release record with data from a GitHub release payload.
     */
