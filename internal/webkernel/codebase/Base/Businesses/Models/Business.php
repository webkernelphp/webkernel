...
namespace Webkernel\Base\Businesses\Models;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Illuminate\Database\Eloquent\Relations\HasMany;
use Webkernel\Base\Businesses\Enum\BusinessStatus;
use Webkernel\Base\Databases\Models\DbConnection;
use Webkernel\Base\Domains\Models\Domain;
use Webkernel\Base\Arcanes\Modules\Models\BusinessModuleMap;
...
class Business extends Model
{
    ...
    {
        return $this->belongsToMany(Module::class, 'business_module_mappings', 'business_id', 'module_id')
