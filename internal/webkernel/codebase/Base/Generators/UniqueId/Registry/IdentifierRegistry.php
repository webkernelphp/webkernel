...
namespace Webkernel\Base\Generators\UniqueId\Registry;

use InvalidArgumentException;
use Webkernel\Base\Generators\UniqueId\Contracts\IdentifierStrategyInterface;
...
final class IdentifierRegistry
{
    ...
    {
        $defaults = [
            'random'     => \Webkernel\Base\Generators\UniqueId\Strategy\RandomStrategy::class,
            'epoch'      => \Webkernel\Base\Generators\UniqueId\Strategy\EpochStrategy::class,
            'nano'       => \Webkernel\Base\Generators\UniqueId\Strategy\NanoStrategy::class,
            'sequential' => \Webkernel\Base\Generators\UniqueId\Strategy\SequentialStrategy::class,
            'username'   => \Webkernel\Base\Generators\UniqueId\Strategy\UsernameStrategy::class,
            'uuidv4'     => \Webkernel\Base\Generators\UniqueId\Strategy\UuidV4Strategy::class,
            'uuidv7'     => \Webkernel\Base\Generators\UniqueId\Strategy\UuidV7Strategy::class,
            'ulid'       => \Webkernel\Base\Generators\UniqueId\Strategy\UlidStrategy::class,
            'sqids'      => \Webkernel\Base\Generators\UniqueId\Strategy\SqidsStrategy::class,
            'cuid2'      => \Webkernel\Base\Generators\UniqueId\Strategy\Cuid2Strategy::class,
            'nanoid'     => \Webkernel\Base\Generators\UniqueId\Strategy\NanoIdStrategy::class,
            'shorthash'  => \Webkernel\Base\Generators\UniqueId\Strategy\ShortHashStrategy::class,
        ];
