...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('base_database_connections', function (Blueprint $table): void {
    ...
    {
        Schema::connection($this->connection)->dropIfExists('base_database_connections');
    }
};
