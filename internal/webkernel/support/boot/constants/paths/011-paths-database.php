...
// Planned (maybe): SQLCipher / Encryption for Sqlite Natively
// I'm concerned about the fact that shared hostings may not support it

// Database path
defined('WEBKERNEL_MAIN_SQLITE_DB_PATH')
    || define('WEBKERNEL_MAIN_SQLITE_DB_PATH', BASE_PATH . '/storage/database.sqlite');
