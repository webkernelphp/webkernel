 ...
 */
define('ENV_PATH', PLATFORM_DIR . '/.env');
/**
 ...
 */
define('WEBKERNEL_SQLITE_PATH', PLATFORM_DIR . '/database.sqlite');
// Webkernel Configuration Constants
define('WEBKERNEL_DB_DRIVER',       'sqlite');
define('WEBKERNEL_DB_PREFIX',       '');
define('WEBKERNEL_DB_FOREIGN_KEYS', true);
define('WEBKERNEL_DB_TIMEOUT',      null);
define('WEBKERNEL_DB_JOURNAL',      null);
define('WEBKERNEL_DB_SYNC',         null);
define('WEBKERNEL_DB_TX_MODE',      'DEFERRED');
// ═══════════════════════════════════════════════════════════════════════════════
...
define('WEBKERNEL_INSTANCE_FILE', PLATFORM_DIR . '/deployment.php');
 ...
 */
define('WEBKERNEL_ERRORS_PAGES_PATH', WEBKERNEL_UPPERPATH . '/resources/views/error-pages');
...
if (!function_exists('webkernel')) {
    function webkernel(): \Webkernel\Base\System\WebkernelAPI
    {
        return app(\Webkernel\Base\System\WebkernelAPI::class);
    }
}
